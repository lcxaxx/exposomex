...
Credits should be given to the core members for their main contributions to the 14 R packages including Bin Wang (extidy, exdb, excros, exmix, expanel, and exstatlink), Mingliang Fang (exnta and exbiolink), Yanqiu Feng (exstat), Ning Gao (exviz), Guohuan Zhang and Yuting Wang (exmo), Mengyuan Ren (exmedt),  Changxin Lan (exsurv),  and Weinan Lin (exmeta). User can also use this packages by web-interaction
