...
#' @title Upload  data file for ExpoStat Module
...
#' @title Create Table 1 for for different epidemilogical study designs
#' @description Create Table 1 for different epidemilogical study designs
#' @usage StatTable1(PID, OutPath="default", EpiDesign = "cohort",
#'    Group, VarsY, VarsC, Missing = "ifany")
#' @param PID chr. Program ID. It must be the same with the PID generated by InitStat.
...
#' @examples res = InitStat()
#'    res1 = LoadStat(PID = res$PID, UseExample = "example#1")
#'    res2 = StatTable1(PID = res$PID, EpiDesign = "cohort" , 
#'    Group = 'T', VarsY = "Y1", VarsC = "C1,C2,C3,C4,C5,C6", 
#'    Missing = "ifany")
#' @author Yanqiu Feng, Bin Wang (corresponding author)
...
#' @title Normality test for numeric variables
#' @description Normality test for numeric variables
#' @usage StatNorm(PID, OutPath="default", Group, Vars, Method = "shapiro.test", Layout = "rose.chart",
...
#' @examples res = InitStat()
#'    res1 = LoadStat(PID = res$PID, UseExample = "example#1")
#'    res2 = StatNorm(PID=res$PID, Group = T, Vars = 'X5,X6,X7,X8,X9',
#'    Method = "shapiro.test",Layout = "rose.chart" , Brightness = "dark",
#'    Palette = "default3")
#' @author Yanqiu Feng, Bin Wang (corresponding author)
...
#' @description Extreme value calculation
#' @usage StatExtre(PID, OutPath="default", Group, Vars, LimitLow = 0.025,
#'    LimitUpper = 0.975, Layout = "column.points", Brightness = "light",
#'    Palette = "default2")
#' @param PID chr. Program ID. It must be the same with the PID generated by InitStat.
...
#' @examples res = InitStat()
#'    res1 = LoadStat(PID = res$PID, UseExample = "example#1")
#'    res2 = StatExtre(PID = res$PID, Group = T, Vars = "X5,X6,X7,X8,X9",
#'    LimitLow = 0.025, LimitUpper = 0.975, Layout = "column.points",
#'    Brightness = "dark", Palette = "default2")
#' @author Yanqiu Feng, Bin Wang (corresponding author)
...
#' @usage StatDesc(PID, OutPath="default", Group, Vars, VarsBy, Layout="box",
#'    Brightness="light", Palette="default1")
#' @param PID chr. Program ID. It must be the same with the PID generated by InitStat.
...
#' @examples res = InitStat()
#'    res1 = LoadStat(PID = res$PID, UseExample = "example#1")
#'    res2 = StatDesc(PID = res$PID, Group = T, Vars = "C1,C2,X5,X6,X7,X8,X9",
#'    VarsBy = NULL, Layout = "box", Brightness = "dark", Palette = "default2")
#' @author Yanqiu Feng, Bin Wang (corresponding author)
...
#' @title Size comparison between groups
#' @description Size comparison between groups
#' @usage StatComp(PID, OutPath="default", Group, Task = "mean",
#'    Vars, VarsBy, Method = "wilcox", Layout = "density", Brightness = "dark" ,
#'    Palette = "default1")
#' @param PID chr. Program ID. It must be the same with the PID generated by InitStat.
...
#' @examples res = InitStat()
#'    res1 = LoadStat(PID = res$PID, UseExample = "example#1")
#'    res2 = StatComp(PID=res$PID, Group = T, Task = "mean", Vars = "X5,X6,X7,X8,X9",
#'    VarsBy = "Y1", Method = "wilcox", Layout = "density", Brightness = "dark",
#'    Palette = "default1")
#' @author Yanqiu Feng, Bin Wang (corresponding author)
...
#' @title Correlation analysis between variables
#' @description Correlation analysis between variables
#' @usage StatCorr(PID, OutPath="default", Group, VarsX, VarsY, VarsBy,
#'    Method = "spearman", Layout= "bubble", Brightness = "dark" , Palette ="default1")
#' @param PID chr. Program ID. It must be the same with the PID generated by InitStat.
...
#' @examples res = InitStat()
#'    res1 = LoadStat(PID = res$PID, UseExample = "example#1")
#'    res2 = StatCorr(PID = res$PID, Group = T, VarsX = "X5,X6,X7,X8,X9", VarsY = "Y1",
#'    VarsBy = "Y1", Method = "pearson", Layout = "bubble", Brightness = "dark",
#'    Palette = "nature")
#' @author Yanqiu Feng, Bin Wang (corresponding author)
