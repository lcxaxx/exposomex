...
#' @usage LoadViz(PID, UseExample = "default", FileDirIn=NULL)
...
#'     res =  LoadViz(PID = res$PID,UseExample = "default",ExdataPath = "D:/test/eg_expoviz_data.xlsx",VodataPath = "D:/test/eg_expoviz_voca.xlsx")
#' @author Ning Gao, Bin Wang (corresponding author)
...
#' @usage VizCateDot(PID,OutPath,Vars, ...)
#' @param PID chr. Program ID. It must be the same with the PID generated by InitBioLink.
...
#'     ata imputation,including T or F.The default option is T.
...
#' @examples res = InitViz()
#'     res1 = LoadViz(PID = res$PID, UseExample = "example#1")
#'     res2 = VizCateDot(PID=res$PID,Group="T",Vars="X4,X5,X6,X7,X8,X9,X10",Parameter="mean",Brightness="light",Palette="default1")
#' @author Ning Gao,Bin Wang(corresponding author)
...
#' @usage CizRelatNetwork(PID,OutPath,VarsY,VarsX,VarsC, ...)
#' @param PID chr. Program ID. It must be the same with the PID generated by InitBioLink.
#' @param OutPath chr. Output file directory. e.g. "D:/test". It should be noted that the slash symbol is "/", not "\".
#'     If "default", the current working directory will be set.
...
#' @examples res = InitViz()
#'     res1 = LoadViz(PID = res$PID, UseExample = "example#1")
#'     res2 = VizRelatNetwork(PID=res$PID,VarsY="Y1",VarsC="all.x",VarsX="all.c",Family="gaussian",Layout="force-directed",CutOff=0.8,Brightness="light",Palette="default1")
#' @author Ning Gao,Bin Wang(corresponding author)
...
VizRelatNetwork = function(PID,
  ...
  res = httr::POST(url,
                   ...
                   encode = 'json')
  results = unserialize(httr::content(res))
  dir.create(paste0(Path,'/Network'))
...
#' @usage VizRelatEdgeBundling(PID,OutPath,VarsY,VarsX,VarsC, ...)
#' @param PID chr. Program ID. It must be the same with the PID generated by InitBioLink.
#' @param OutPath chr. Output file directory. e.g. "D:/test". It should be noted that the slash symbol is "/", not "\".
#'     If "default", the current working directory will be set.
...
#' @examples res = InitViz()
#'     res1 = LoadViz(PID = res$PID, UseExample = "example#1")
#'     res2 = VizRelatEdgeBundling(PID=res$PID,VarsY = "Y2",VarsX = "all.x",VarsC = "C2",Family = "gaussian" ,SizeFor = "pvalue",Brightness = "light",Palette = "default1")
#' @author Ning Gao,Bin Wang(corresponding author)
...
VizRelatEdgeBundling = function(PID,
  ...
  res = httr::POST(url,
                   ...
                   encode = 'json')
  results = unserialize(httr::content(res))
  dir.create(paste0(Path,'/EdgeBundling'))
...
#' @usage VizRelatHeatmap(PID,OutPath,VarsY,VarsX, ...)
#' @param PID chr. Program ID. It must be the same with the PID generated by InitBioLink.
#' @param OutPath chr. Output file directory. e.g. "D:/test". It should be noted that the slash symbol is "/", not "\".
#'     If "default", the current working directory will be set.
#' @param Group lgl.Whether to separate dataset into train and test datasets for d
...
#' @examples res = InitViz()
#'     res1 = LoadViz(PID = res$PID, UseExample = "example#1")
#'     res2 = VizRelatHeatmap(PID=res$PID,Group = "T",VarsY = "Y2",VarsX = "X1,X4,X5,X6,X7,X8,X9,X10",Method = "spearman",Brightness = "light",Palette = "default1")
#' @author Ning Gao, Bin Wang (corresponding author)
...
VizRelatHeatmap = function(PID,
  ...
  res = httr::POST(url,
                   ...
                   encode = 'json')
  results = unserialize(httr::content(res))
  dir.create(paste0(Path,'/Heatmap'))
...
#' @usage VizRelatMatrix(PID,OutPath,VarsY,VarsX, ...)
#' @param PID chr. Program ID. It must be the same with the PID generated by InitBioLink.
#' @param OutPath chr. Output file directory. e.g. "D:/test". It should be noted that the slash symbol is "/", not "\".
#'     If "default", the current working directory will be set.
...
#' @examples res = InitViz()
#'     res1 = LoadViz(PID = res$PID, UseExample = "example#1")
#'     res2 = VizRelatMatrix(PID=res$PID,Group = "F",VarsY = "Y2",VarsX = "X4,X5,X6,X7,X8,X9,X10",Method = "spearman")
#' @author Ning Gao, Bin Wang (corresponding author)
...
#' @usage VizDistrSierra(PID,OutPath,Vars, ...)
#' @param PID chr. Program ID. It must be the same with the PID generated by InitBioLink.
#' @param OutPath chr. Output file directory. e.g. "D:/test". It should be noted that the slash symbol is "/", not "\".
#'     If "default", the current working directory will be set.
#' @param Group lgl.Whether to separate dataset into train and test datasets for 
...
#' @examples res = InitViz()
#'     res1 = LoadViz(PID = res$PID, UseExample = "example#1")
#'     res2 = VizDistrSierra(PID=res$PID,Group = "T",Vars = "X14,X15,X16,X17,X18,X19,X20",Brightness = "light",Palette = "default1")
#' @author Ning Gao,Bin Wang(corresponding author)
...
VizDistrSierra = function(PID,
  ...
  results = unserialize(httr::content(res))
  dir.create(paste0(Path,'/DistrSierra'))
...
#' @examples res = InitViz()
#'     res1 = LoadViz(PID = res$PID, UseExample = "example#1")
#'     res2= VizCompoDendrogram(PID=res$PID,Group = "T",Vars = "X4,X5,X6,X7,X8,X61,X66,X67,X200",Parameter = "median",DistMethod = "euclidean",ClusterMethod = "ward.D2",ClusterNum = "4",Brightness = "light",Palette = "default1")
#' @author Ning Gao,Bin Wang(corresponding author)
...
VizCompoDendrogram = function(PID,
  ...
  results = unserialize(httr::content(res))
  dir.create(paste0(Path,'/Dendrogram'))
...
#' @return
#' @export
#' @examples OutPath = getwd()
#'    res = InitViz()
#'    res = LoadViz(PID = res$PID,UseExample = "example#1")
#'    res2 = VizCateDot(PID=res$PID,OutPath = Path,Group = "T",Vars = "X4,X5,X6,X7,X8,X9,X10",Parameter = "mean",
