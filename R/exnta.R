...
#' @usage FindCovaNta(PID, OutPath = "default", VarsY, VarsC_Prior = "default",
...
#'    res2 = FindCovaNta(PID=res$PID, VarsY = "Y1", VarsC_Prior = "default",
#'    VarsC_Fixed = "C2", Method = "single.factor", Thr = 0.1)
#' @author Mingliang Fang, Bin Wang (corresponding author)
...
#' @usage NtaCros(PID,OutPath = "default", VarsY, VarsX = "all.x",
...
#' @examples res <- InitNTA()
#'    res1 = LoadNTA(PID = res$PID, UseExample = "example#1")
#'    res2 = NtaCros(PID=res$PID, VarsY = "Y1", VarsX = "all.x",
#'    VarsN = "single.factor", FdrCorrect = T, SelMethod = "all",
#'    StepwizeThr = 0.1, RF_ImpThr = 0.9, IncCova = "F", Family = "gaussian",
#'    RepMsr = "F", Corstr = "ar1")
#' @author Mingliang Fang, Bin Wang (corresponding author)
...
#'    StepwizeThr = 0.1, RF_ImpThr = 0.9, IncCova = "F", Family = "gaussian",
#'    RepMsr = "F", Corstr = "ar1")
#'    res3 = VizNtaCros(PID=res$PID, VarsY = "Y1",VarsN = "single.factor",
...
#' @usage NtaAnno(PID, OutPath = "default", VarsY, VarsX  = "default",
...
#'    res1 = LoadNTA(PID = res$PID, UseExample = "example#1")
#'    res2 = NtaCros(PID=res$PID, VarsY = "Y1", VarsX = "all.x",
#'    VarsN = "single.factor", FdrCorrect = TRUE, SelMethod = "all",
#'    StepwizeThr = 0.1, RF_ImpThr = 0.9, IncCova = "F", Family = "gaussian",
#'    RepMsr = "F", Corstr = "ar1")
#'    res3 = NtaAnno(PID=res$PID,VarsY = "Y1",VarsX = "default",VarsN = "single.factor",
...
#' @usage VizNtaAnno(PID, OutPath = "default", VarsY, VarsN ,Accuracy = 1,
...
#'    res3 = NtaAnno(PID=res$PID,VarsY = "Y1",VarsX = "default",VarsN = "single.factor",
#'    FdrCorrect = "F",AdductPos = "M+H",AdductNeg = "M-H",Accuracy = 1)
#'    res4 = VizNtaAnno(PID=res$PID, VarsY = "Y1",VarsN = "single.factor",
