...
#' @usage LoadViz(PID, UseExample = "example#1",DataPath=NULL,VocaPath=NULL)
...
#' @usage VizCateDot(PID,OutPath="default",Group="F",Vars,Parameter="mean",
#'     Brightness="light",Palette="default1")
#' @param PID chr. Program ID. It must be the same with the PID generated by InitViz.
#' @param OutPath chr. Output file directory, e.g. "D:/test". It should be noted
...
#' @return One or three ggplot plots which can be further modified using the ggplot2 package.
#'     When Group=T,
...
#' @examples res = InitViz()
#'     res1 = LoadViz(PID = res$PID, UseExample = "example#1")
#'     res2 = VizCateDot(PID=res$PID,OutPath="default",Group="F",Vars="X4,X5,X6,X7,X8,X9,X10",
#'     Parameter="mean",Brightness="light",Palette="default1")
#' @author Ning Gao,Bin Wang(corresponding author)
...
VizCateDot = function(PID,
  ...
  res = httr::POST(url,
                   ...
                   encode = 'json')
  results = unserialize(httr::content(res))
  dir.create(paste0(OutPath,'/VizCate'))
  for (name in names(results$Cate_Dot)){
    try(
      ggplot2::ggsave(paste0(OutPath,'/VizCate/',Parameter,'_',name,".png"),
...
#' @usage VizRelatNetwork(PID,OutPath="default",VarsY,VarsC="all.c",VarsX="all.x",
...
#'     or input a character string specifying the variables,separated by comma ","
#'     without space(e.g."X4,X5,X6,X7,X8,X9,X10").
#' @param Family chr. The link function for the regression model according the data
...
#' @param Layout chr. Visualization layout. Available options include "force-directed"
#'     and "degree-circle".
...
#' @param Brightness chr. Visualization brightness. Available options include "light"
#'     and "dark".
#' @param Palette chr. Visualization palette. Available options include "default1",
...
#' @details The network plot is used to visualize the relationship between the input
#'     variables by using ggraph package.
#' @return A ggplot plot which can be further modified using the ggplot2 package.
...
VizRelatNetwork = function(PID,
  ...
  res = httr::POST(url,
                   ...
                   encode = 'json')
  results = unserialize(httr::content(res))
  dir.create(paste0(OutPath,'/VizNetwork'))
  for (name in names(results$Relat_Network)){
    try(
      ggplot2::ggsave(paste0(OutPath,'/VizNetwork', "/network_",Layout,"_",
                             Brightness,"_",
                             Palette,".png"),
...
#' @usage VizRelatEdgeBundling(PID,OutPath="default",VarsY, VarsC="all.c", VarsX = "all.x",
#'     Family = "gaussian", SizeFor = "pvalue",Brightness = "light",
#'     Palette = "default1")
#' @param PID chr. Program ID. It must be the same with the PID generated by InitViz.
#' @param OutPath chr. Output file directory. e.g. "D:/test". It should be noted
#'     that the slash symbol is "/", not "\".If "default", the current working
...
#'     determined by data type of an outcome, or the plot can not be visualized.The
#'     default option is "gaussian".
#' @param SizeFor chr. Parameter to represent the size of the points in the output plot.
#'     Available options include "pvalue" and "beta".The default option is "pvalue".
#' @param Brightness chr. Visualization brightness. Available options include "light" and "dark".
#' @param Palette chr. Visualization palette. Available options include "default1",
#'     "default2" and "Journal". The "Journal" option provides several journal preference
#'     styles including cell, nature, science, lancet, nejm, and jama.
#' @details The edge bundling plot is used to bundle the edges closely in order to
#'     reduce complexity.
#' @return A ggplot plot which can be further modified using the ggplot2 package.
#'     (1) "light_default1": the visualization result;
#' @export
...
#'     VarsX = "all.x",VarsC = "all.c",Family = "gaussian" ,SizeFor = "pvalue",
#'     Brightness = "light",Palette = "default1")
#' @author Ning Gao,Bin Wang(corresponding author)
...
VizRelatEdgeBundling = function(PID,
  ...
  res = httr::POST(url,
                   ...
                   encode = 'json')
  results = unserialize(httr::content(res))
  dir.create(paste0(OutPath,'/VizEdgeBundling'))
  for (name in names(results$Relat_EdgeBundling)){
    try(
      ggplot2::ggsave(paste0(OutPath,'/VizEdgeBundling', "/EdgeBundling_",SizeFor,
...
#' @usage VizRelatHeatmap(PID,OutPath="default",Group = "F",VarsY,VarsX,
#'     Method = "spearman",Brightness = "light",Palette = "default1")
#' @param PID chr. Program ID. It must be the same with the PID generated by InitViz.
#' @param OutPath chr. Output file directory. e.g. "D:/test". It should be noted
#'     that the slash symbol is "/", not "\". If "default", the current working
#'     directory will be set.
...
#'    and "Journal". The "Journal" option provides several journal preference styles
#'    including cell, nature, science, lancet, nejm, and jama.
#' @details The heatmap plot is used to display data in color changes as a matrix.
#' @return One or two ggplot plots which can be further modified using the ggplot2 package.
#'     When Group=T,
...
VizRelatHeatmap = function(PID,
  ...
  res = httr::POST(url,
                   ...
                   encode = 'json')
  results = unserialize(httr::content(res))
  dir.create(paste0(OutPath,'/VizHeatmap'))
  for (i in c(1:length(results$Relat_Heatmap))){
    try(
      ggplot2::ggsave(paste0(OutPath,'/VizHeatmap', "/Heatmap_",names(results$Relat_Heatmap)[i],"_",Method,".png"),
...
#' @usage VizRelatMatrix(PID,OutPath="default",Group = "F",VarsY,VarsX,Method = "spearman")
#' @param PID chr. Program ID. It must be the same with the PID generated by InitViz.
#' @param OutPath chr. Output file directory. e.g. "D:/test". It should be noted t
#'     hat the slash symbol is "/", not "\". If "default", the current working directory
#'     will be set.
#' @param Group lgl.Whether to separate dataset into train and test datasets for
#'     data imputation,including T or F.The default option is F.
#' @param VarsY chr. Dependent variables for visualization(e.g."Y2").
...
#'     or input a character string specifying the variables,separated by comma ","
#'     without space(e.g."X4,X5,X6,X7,X8,X9,X10").
#'     Notice that no more than 20 variables can be inputed.(< 20 variables).
#' @param Method chr. Method to calculate the correlation. Default option is "spearman".
#' @details The matrix plot is used to make a matrix of plots with a given data set.
#' @return One or two ggmatrix plots which can be further modified using the ggplot2 package.
#'     When Group=T,
#'     (1) "Train": the train dataset visualization result;
#'     (2) "Test": the test dataset visualization result.
#'     When Group=F,
#'     (1) "All": the whole dataset visualization result.
#' @export
#' @examples res = InitViz()
#'     res1 = LoadViz(PID = res$PID, UseExample = "example#1")
...
VizRelatMatrix = function(PID,
  ...
  message("Notice that no more than 20 independent variables can be entered,
          or the plot can not be visualized!")
  ...
  res = httr::POST(url,
                   ...
                   encode = 'json')
  results = unserialize(httr::content(res))
  dir.create(paste0(OutPath,'/VizMatrix'))
  for (i in c(1:length(results$Relat_Matrix))){
    try(
      ddpcr::quiet(ggplot2::ggsave(paste0(OutPath,'/VizMatrix', "/Matrix_",names(results$Relat_Matrix)[i],"_",Method,".png"),
...
#' @usage VizDistrSierra(PID,OutPath="default",Group = "F",Vars,Brightness = "light",
#'     Palette = "default1")
#' @param PID chr. Program ID. It must be the same with the PID generated by InitViz.
#' @param OutPath chr. Output file directory. e.g. "D:/test". It should be noted
#'     that the slash symbol is "/", not "\". If "default", the current working
...
#' @param Group lgl.Whether to separate dataset into train and test datasets for
#'     data imputation,including T or F.The default option is F.
#' @param Vars chr. Variables to be visualized(e.g."X4,X5,X6,X7,X8,X9,X10").Available
#'     options include:
#'     "all.x", all independent variables;
#'     "all.c", all covariate variables;
#'     "all.cx", combination of all.x and all.c;
#'     or input a character string specifying the variables,separated by comma ","
#'     without space(e.g."X4,X5,X6,X7,X8,X9,X10"). No more than 50 variables be
#'     entered is recommended (< 20 variables).
#' @param Brightness chr. Visualization brightness. Available options include "light" and "dark".
#' @param Palette chr. Visualization palette. Available options include "default1", "default2"
#'    and "Journal". The "Journal" option provides several journal preference styles
#'    including cell, nature, science, lancet, nejm, and jama.
#' @details The sierra plot is used to visualize the kernel density estimation of data.
#' @return One or three ggplot plots which can be further modified using the ggplot2 package.
#'     When Group=T,
#'     (1) "all_light_default1": the whole dataset visualization result;
#'     (2) "train_light_default1": the train dataset visualization result;
...
#'     Vars = "X14,X15,X16,X17,X18,X19,X20",Brightness = "light",Palette = "default1")
#' @author Ning Gao,Bin Wang(corresponding author)
...
VizDistrSierra = function(PID,
  ...
  results = unserialize(httr::content(res))
  dir.create(paste0(OutPath,'/VizDistrSierra'))
  for (name in names(results$Sierra)){
    try(
      ggplot2::ggsave(paste0(OutPath,'/VizDistrSierra/','Sierra_',name,".png"),
...
#' @usage VizCompoDendrogram(PID,OutPath="default",Group = "T",Vars,
#'     Parameter = "median",DistMethod = "euclidean", ClusterMethod = "ward.D",
#'     ClusterNum = "4",Brightness = "light",Palette = "default1")
#' @param PID chr. Program ID. It must be the same with the PID generated by InitViz.
#' @param OutPath chr. Output file directory. e.g. "D:/test". It should be noted
#'     that the slash symbol is "/", not "\". If "default", the current working
#'     directory will be set.
...
VizCompoDendrogram = function(PID,
  ...
  results = unserialize(httr::content(res))
  dir.create(paste0(OutPath,'/VizDendrogram'))
  for (name in names(results$Dendrogram)){
    try(
      ggplot2::ggsave(paste0(OutPath,'/VizDendrogram/Dendrogram_',name,'_',
                             Parameter,'_',
                             DistMethod,'_',
                             ClusterMethod,'_',name,'_',".png"),
