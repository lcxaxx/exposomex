...
#' @examples res <- InitDb()
#'    res1 = LoadDb(PID = res$PID, UseExample = "example#1")
#'    res2 = ExpoAbbr(PID=res$PID, Keys = "default")
#'    FuncExit(PID = res$PID)
#' @author Bin Wang
...
#' @examples res <- InitDb()
#'    res1 = LoadDb(PID = res$PID, UseExample = "example#1")
#'    res2 = ExpoDict(PID=res$PID, Class = "GO", Keys = "default")
#'    FuncExit(PID = res$PID)
#' @author Bin Wang
...
#' @usage ExpoConv(PID, OutPath = "default", From, To, Keys)
#' @param PID chr. Program ID. It must be the same with the PID generated by ExpoDB
...
#' @examples res <- InitDb()
#'    res1 = LoadDb(PID = res$PID, UseExample = "example#1")
#'    res2 = ExpoConv(PID=res$PID, From = "chemical", To = "cas.rn", Keys = "default")
#'    FuncExit(PID = res$PID)
#' @author Bin Wang
...
#' @usage ExpoNexus(PID, OutPath = "default", ClassA, ClassB,
#'    KeysA = "default", KeysB = "default")
#' @param PID chr. Program ID. It must be the same with the PID generated by ExpoDB
#' @param OutPath chr. Output file directory, e.g. "D:/test". It should be noted that
#'    the slash symbol is "/", not "\". If "default", the current working directory will be set.
...
#' @examples res <- InitDb()
#'    res1 = LoadDb(PID = res$PID, UseExample = "example#1")
#'    res2 = ExpoNexus(PID=res$PID, ClassA = "chemical", ClassB = "protein",
#'    KeysA = "default", KeysB = "default")
#'    FuncExit(PID = res$PID)
#' @author Bin Wang
...
#' @usage ExpoAnno(PID, OutPath = "default", MassToCharge, AdductPos,
...
#'    "M+2Na-H,M+ACN+Na,M+H+Na,M+2K-H,M+H+NH4,2M+K,M+K,2M+NH4,2M+Na,
#'    M+2Na,M+DMSO+H,M+2ACN+H,M+IsoProp+Na+H,M+2H+Na,M+ACN+2H,M+H,
#'    2M+H,M+CH3OH+H,M+H+2Na,M+Na",2M+ACN+H,2M+ACN+Na,M+IsoProp+H,M+H+K"
...
#' @examples res <- InitDb()
#'    res1 = LoadDb(PID = res$PID, UseExample = "example#1")
#'    res6 = ExpoAnno(PID=res$PID, MassToCharge = "default", AdductPos = "all",
#'    AdductNeg = "all", Accuracy = 5)
#'    FuncExit(PID = res$PID)
#' @author Bin Wang
