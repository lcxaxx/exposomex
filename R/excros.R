...
#' @usage FindCovaCros(PID, OutPath = "default", VarsY, VarsC_Prior = "default",
...
#' @examples res <- InitCros()
#'    res1 = LoadCros(PID = res$PID, UseExample = "example#1")
#'    res2 = FindCovaCros(PID=res$PID, VarsY = "Y1",
...
#' @usage CrosAsso(PID, OutPath = "default", EpiDesign = "cross.sectional",
#'     VarsY, VarsX = "all.cx",VarsN = "single.factor", VarsSel = FALSE, VarsSelThr = 0.1,
#'     IncCova = TRUE, Family ,RepMsr = FALSE, Corstr = "ar1")
#' @param PID chr. Program ID. It must be the same with the PID generated by ExpoCros
...
#'     Available options.
#' @param VarsSelThr num. If "VarsSel" = TRUE, provide the selection threshold
#'     of the P-value. three values can be chosen, i.e. 0.05, 0.1, and 0.2.
...
#'     Available options.
#' @param Corstr chr. If "RepMsr" = TRUE, the generalized estimating equations (GEE) will be used.
...
#'    VarsSel = FALSE, VarsSelThr = 0.1, IncCova = TRUE, Family = "gaussian",
...
#' @usage VizCrosAsso(PID, OutPath = "default", VarsY, VarsN,
...
#'    VarsSel = FALSE, VarsSelThr = 0.1, IncCova = TRUE, Family = "gaussian",
#'    RepMsr = FALSE,Corstr = "ar1")
#'    res3 = VizCrosAsso(PID=res$PID,VarsY = "Y1",VarsN="single.factor", Layout = "forest",
...
#' @usage CrosPred(PID, OutPath = "default", VarsY, VarsX = "all.x",
#'     PredType = "response", VarsSel = FALSE, VarsSelThr = 0.1, IncCova = TRUE,
...
#' @param VarsSelThr num. If "VarsSel" = TRUE, provide the selection threshold of
#'     the P-value. three values can be chosen, i.e. 0.05, 0.1, and 0.2.
...
#' @examples res <- InitCros()
#'    res1 = LoadCros(PID = res$PID, UseExample = "example#1")
#'    res2 = CrosPred(PID=res$PID, VarsY = "Y1", VarsX = "X5,X6,X7,X8,X9,X10,X11",
#'    PredType = "response", VarsSel = FALSE, VarsSelThr = 0.1, IncCova = FALSE,
#'    RsmpMethod = "cv", Folds = 5, Ratio = 0.667, Repeats = 5)
#'    FuncExit(PID = res$PID)
#' @author Bin Wang
...
#' @usage VizCrosPred(PID, OutPath = "default", VarsY, Layout = "bar", Brightness = "light",
#'     Palette = "default1")
#' @param PID chr. Program ID. It must be the same with the PID generated by ExpoCros
#' @param OutPath chr. Output file directory, e.g., "D:/test". It should be noted that the slash symbol is "/", not "\".
#'     If "default", the current working directory will be set.
...
#'    PredType = "response", VarsSel = FALSE, VarsSelThr = 0.1,IncCova = FALSE,
#'    RsmpMethod = "cv", Folds = 5, Ratio = 0.667, Repeats = 5)
#'    res3 = VizCrosPred(PID=res$PID, VarsY = "Y1", Layout = "bar", Brightness = "light",
#'    Palette = "science")
#'    FuncExit(PID = res$PID)
#' @author Bin Wang
