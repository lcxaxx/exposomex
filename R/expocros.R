...
#' @usage VizCrosAsso(PID, OutPath = "default",VarsN = "single.factor",
...
#'    VarsSel = FALSE, VarsSelThr = 0.1, IncCova = TRUE, Family = "gaussian",
#'    RepMsr = FALSE,Corstr = "ar1")
#'    res3 = VizCrosAsso(PID=res$PID,VarsN="single.factor", Layout = "forest",
...
#' @examples res <- InitCros()
#'    res1 = LoadCros(PID = res$PID, UseExample = "example#1")
#'    #res2 = TransScale(PID=res$PID, Group=TRUE, Vars="all.x", Method="normal")
...
#' @usage VizCrosPred(PID,OutPath = "default",Layout = "bar",
